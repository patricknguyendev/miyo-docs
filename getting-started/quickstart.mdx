...
description: "Set up Miyo from a new account: choose individual or household use, add your first account, review transactions, and build an initial monthly plan."
