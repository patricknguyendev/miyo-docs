...
<Steps>
  ...
  <Step title="Choose the source and account">
    Select the matching institution format or the generic mapping, then select the Miyo account that should receive the records.
  </Step>
  <Step title="Review the preview">
    Confirm that Miyo interprets dates, descriptions, and positive or negative amounts correctly before continuing.
  </Step>
