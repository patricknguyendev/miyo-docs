...
description: "Create a Miyo savings goal to track progress toward one total amount, add an optional target date, and see the pace needed to reach the finish line."
keywords: ["goal", "savings", "target amount", "target date", "progress"]
---

A savings goal tracks one total amount you want to reach. It is different from a spending budget: a budget shows how much remains available to spend, while a savings goal shows how much progress you have made toward a finish line.
